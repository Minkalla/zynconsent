 ...
 * description: This endpoint allows recording a user's consent status for a specific type.
 * For MVP, consent data is stored in-memory.
 * requestBody:
 * required: true
 * content:
 * application/json:
 ...
 * description: This endpoint returns a chronological list of all consent events recorded for a given user ID.
 * For MVP, data is retrieved from in-memory storage.
 * This endpoint helps with GDPR's "right to access" principle.
 * parameters:
 * - in: path
 * name: userId
 * required: true
